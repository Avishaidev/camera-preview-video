...
export class ColorPickerComponent {
  ...
  @ViewChild("palette") palette;// this is the main palette
  @ViewChild("chooser") chooser;// this is the color chooser
  ...
  drawChooser(ctx : CanvasRenderingContext2D){
    ...
    gradient.addColorStop(0.18,    "rgb(255,   0,   0)");
    gradient.addColorStop(0.24, "rgb(255,   0, 255)");
    gradient.addColorStop(0.36, "rgb(0,     0, 255)");
    gradient.addColorStop(0.48, "rgb(0,   255, 255)");
    gradient.addColorStop(0.60, "rgb(0,   255,   0)");
    gradient.addColorStop(0.72, "rgb(255, 255,   0)");
    gradient.addColorStop(0.84, "rgb(255,   0,   0)");
  ...
  getColor(event, canvas, context, fromChooser : boolean) : string {
    ...
    var pageX = 0;
    var pageY = 0;
    if (event.type.toLowerCase().indexOf('touch') > -1) {
    ...
    var y = (pageX - bounding.left) * this.getPixelRatio(context);
    var x = (pageY - bounding.top) * this.getPixelRatio(context);
